//01 jet
#define MET_PUPPI_process_cxx
#include "MET_PUPPI_process.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "../Detector.hh"
...
void MET_PUPPI_process::Loop()
{
    ...
    TCanvas *c1 = new TCanvas("METPUPPICanvasforSumPTandPT_n2n2","METPUPPI Canvas for SumPT and PT_n2n2",750,500);
    TCanvas *c2 = new TCanvas("METPUPPICanvasforSumPTdividedbyPT_n2n2","METPUPPI Canvas for SumPT divided by PT_n2n2",750,500);
    TCanvas *c3 = new TCanvas("METPUPPICanvasforSumPTdividedbyPT_n2n2vsPT_n2n2","METPUPPI Canvas for SumPT divided by PT_n2n2 vs PT_n2n2",750,500);
    TCanvas *c4 = new TCanvas("METPUPPICanvasforPT_n2n2","METPUPPI Canvas for PT_n2n2",750,500);
    TCanvas *c5 = new TCanvas("METPUPPICanvasforMETResolution_SumPT","METPUPPI Canvas for MET Resolution SumPT",750,500);
    TCanvas *c6 = new TCanvas("METPUPPICanvasforMETResolution_PT_n2n2","METPUPPI Canvas for MET Resolution PT_n2n2",750,500);
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        for(int i=0; i<JetPUPPI_Delphes_Size; i++)
        {
            sum_PT+=JetPUPPI_Delphes_PT->at(i);
        }
        ...
        MET_Delphes.SetPtEtaPhi(PUPPI_MET_PT,PUPPI_MET_Eta,PUPPI_MET_Phi);
    ...
    */
    ...
    for(int i=0; i<Ninterval_SumPT; i++)
    {
        ...
        std::sprintf(canvasname_Parallel_SumPT,"PUPPI_canvas_MET_Parallel_SumPT__%d",i);
        string canvasname_Parallel_SumPT_str = "PUPPI_canvas_MET_Parallel_SumPT_"+std::to_string(i);
        ...
        std::sprintf(canvasname_Perpendicular_SumPT,"PUPPI_canvas_MET_Perpendicular_SumPT__%d",i);
        string canvasname_Perpendicular_SumPT_str = "PUPPI_canvas_MET_Perpendicular_SumPT_"+std::to_string(i);
        ...
        std::sprintf(histname_Parallel_SumPT,"PUPPI_hist_MET_Parallel_SumPT__%d",i);
        string histname_Parallel_SumPT_str = "PUPPI_hist_MET_Parallel_SumPT_"+std::to_string(i);
        ...
        std::sprintf(histname_Perpendicular_SumPT,"PUPPI_hist_MET_Perpendicular_SumPT__%d",i);
        string histname_Perpendicular_SumPT_str = "PUPPI_hist_MET_Perpendicular_SumPT_"+std::to_string(i);
    ...
    for(int i=0; i<Ninterval_PT_n2n2; i++)
    {
        ...
        std::sprintf(canvasname_Parallel_PT_n2n2,"PUPPI_canvas_MET_Parallel_PT_n2n2__%d",i);
        string canvasname_Parallel_PT_n2n2_str = "PUPPI_canvas_MET_Parallel_PT_n2n2_"+std::to_string(i);
        ...
        std::sprintf(canvasname_Perpendicular_PT_n2n2,"PUPPI_canvas_MET_Perpendicular_PT_n2n2__%d",i);
        string canvasname_Perpendicular_PT_n2n2_str = "PUPPI_canvas_MET_Perpendicular_PT_n2n2_"+std::to_string(i);
        ...
        std::sprintf(histname_Parallel_PT_n2n2,"PUPPI_hist_MET_Parallel_PT_n2n2__%d",i);
        string histname_Parallel_PT_n2n2_str = "PUPPI_hist_MET_Parallel_PT_n2n2_"+std::to_string(i);
        ...
        std::sprintf(histname_Perpendicular_PT_n2n2,"PUPPI_hist_MET_Perpendicular_PT_n2n2__%d",i);
        string histname_Perpendicular_PT_n2n2_str = "PUPPI_hist_MET_Perpendicular_PT_n2n2_"+std::to_string(i);
    ...
    */
    ...
    if(Save)
        c2->SaveAs("SumPT_over_n2n2PT.png");
    c2->Write();
    ...
    if(Save)
        c3->SaveAs("SumPT_over_n2n2PT_vs_n2n2PT.png");
    c3->Write();
    ...
    */
    ...
    for(int i=0; i < Ninterval_SumPT; i++)
    {
        ...
        cout << endl;
        TF1* func_gaus_PT_n2n2_par_PUPPI = new TF1("func_gaus_PT_n2n2_par_PUPPI","gaus");
        //func_gaus_PT_n2n2_par_PUPPI->FixParameter(1,0.0);
        vect_hist_MET_Parallel_SumPT.at(i)->Fit(func_gaus_PT_n2n2_par_PUPPI,"");
        ...
        sigmaMETpar_SumPT[i] = func_gaus_PT_n2n2_par_PUPPI->GetParameter(2)/sumPT[i];
        sigmaMETpar_err_SumPT[i] = func_gaus_PT_n2n2_par_PUPPI->GetParError(2)/sumPT[i];
        
        vect_canvas_MET_Perpendicular_SumPT.at(i)->cd();
        vect_hist_MET_Perpendicular_SumPT.at(i)->Draw();
        cout << endl;
        TF1* func_gaus_PT_n2n2_perp_PUPPI = new TF1("func_gaus_PT_n2n2_perp_PUPPI","gaus");
        //func_gaus_PT_n2n2_perp_PUPPI->FixParameter(1,0.0);
        vect_hist_MET_Perpendicular_SumPT.at(i)->Fit(func_gaus_PT_n2n2_perp_PUPPI,"");
        ...
        sigmaMETperp_SumPT[i] = func_gaus_PT_n2n2_perp_PUPPI->GetParameter(2)/sumPT[i];
        sigmaMETperp_err_SumPT[i] = func_gaus_PT_n2n2_perp_PUPPI->GetParError(2)/sumPT[i];
    }
     */
    for(int i=0; i<Ninterval_PT_n2n2; i++)
    {
        ...
        cout << endl;
        vect_hist_MET_Parallel_PT_n2n2.at(i)->Fit("gaus","");
        ...
        sigmaMETpar_PT_n2n2[i] = func->GetParameter(2)/PT_n2n2[i];
        sigmaMETpar_err_PT_n2n2[i] = func->GetParError(2)/PT_n2n2[i];
        
        vect_canvas_MET_Perpendicular_PT_n2n2.at(i)->cd();
        vect_hist_MET_Perpendicular_PT_n2n2.at(i)->Draw();
        cout << endl;
        vect_hist_MET_Perpendicular_PT_n2n2.at(i)->Fit("gaus","");
        ...
        sigmaMETperp_PT_n2n2[i] = func->GetParameter(2)/PT_n2n2[i];
        sigmaMETperp_err_PT_n2n2[i] = func->GetParError(2)/PT_n2n2[i];
    }
    ...
    if(Save)
        c5->SaveAs("PUPPI_Resolution_vs_SumPT.png");
    c5->Write();
    */
    Plot_Res_vs_PT_n2n2(gr_perp_PT_n2n2,gr_par_PT_n2n2,c6);
    if(Save)
        c6->SaveAs("PUPPI_Resolution_vs_PT_n2n2.png");
    c6->Write();
