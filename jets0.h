...
// Tue Mar  6 09:19:41 2018 by ROOT version 6.10/08
// from TTree LHEF/Analysis tree
// found on file: n2n2_200_0jets.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 27;
...
#ifdef jets0_cxx
jets0::jets0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("n2n2_200_0jets.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("n2n2_200_0jets.root");
      }
...
Int_t jets0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jets0::LoadTree(Long64_t entry)
{
...
void jets0::Show(Long64_t entry)
{
...
Int_t jets0::Cut(Long64_t entry)
{
