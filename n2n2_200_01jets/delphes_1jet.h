...
// Thu Mar 29 16:36:53 2018 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: delphes_n2n2_200_1jets.root
//////////////////////////////////////////////////////////

#ifndef delphes_1jet_h
#define delphes_1jet_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 874;
   static constexpr Int_t kMaxTrack = 122;
   static constexpr Int_t kMaxTower = 164;
   static constexpr Int_t kMaxEFlowTrack = 122;
   static constexpr Int_t kMaxEFlowPhoton = 73;
   static constexpr Int_t kMaxEFlowNeutralHadron = 62;
   ...
   delphes_1jet(TTree *tree=0);
   virtual ~delphes_1jet();
...
#ifdef delphes_1jet_cxx
delphes_1jet::delphes_1jet(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("delphes_n2n2_200_1jets.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("delphes_n2n2_200_1jets.root");
      }
...
delphes_1jet::~delphes_1jet()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t delphes_1jet::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t delphes_1jet::LoadTree(Long64_t entry)
{
...
void delphes_1jet::Init(TTree *tree)
{
...
void delphes_1jet::Show(Long64_t entry)
{
...
Int_t delphes_1jet::Cut(Long64_t entry)
{
