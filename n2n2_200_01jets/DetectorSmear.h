//header file for smearing a set of events
//write functions to smear MET, Jet, Muon, Electron, CM of event (chi_2)
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <stdio.h>
...
TVector3 PT_true_TV3(TLorentzVector* n1A_MC, TLorentzVector* n1B_MC)
{
    TVector3 PT_true;
...
TLorentzVector Create_PV(const TLorentzVector& n2A_MC, const TLorentzVector& n2B_MC) //create a Primary Vertex
{
...
TLorentzVector Smear_PV(const TLorentzVector& PV_MC)//, double Time_Resolution)
{
...
TLorentzVector Create_SV(const TLorentzVector& n2_MC)//, double Decay_Time)
{
    //Decay_Time=1202.012;
...
TLorentzVector Smear_SV(const TLorentzVector& SV_MC)//, double Time_Resolution)
{
